...
router.post('/projectregister', mid.authenticationMiddleware,authController.projectregister);//FRONTEND PENDING
...
router.post('/studentupload',mid.authenticationMiddleware,authController.uploadphase)//FRONTEND PENDING
router.get('/studentteam',mid.authenticationMiddleware,authController.studentteam)//FRONTEND PENDING
